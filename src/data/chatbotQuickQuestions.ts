...
export const quickQuestionsByContext: Record<ChatContext, QuickQuestion[]> = {
  ...
  'super-admin': [
    ...
    { id: 'sa5', label: 'System settings?', question: 'How do I configure system settings as Super Admin?', category: 'Settings' },
    ...
    { id: 'sa9', label: 'Backup data?', question: 'How does backup and restore work in the system?', category: 'Admin' },
    { id: 'sa10', label: 'Audit logs?', question: 'Does the system track audit logs and activity monitoring?', category: 'Security' },
    { id: 'sa11', label: 'Session timeout?', question: 'How do I configure session timeout in system settings?', category: 'Settings' },
    { id: 'sa12', label: 'Notifications?', question: 'How do I enable email notifications and attendance reminders?', category: 'Settings' },
